  ...
  return (
    <div className="container w-50 mt-5 pb-5 shadow p-3 mb-5 bg-white rounded translate-wrap">
      <div className="row d-flex justify-content-between mb-3">
        ...
        <div className="col-5">
          <select className="form-select w-100 no-border" aria-label="Default select example" onChange={onFromChange} defaultValue='en'>
            <option value="en">English</option><option value="ar">Arabic</option><option value="zh">Chinese</option><option value="fr">French</option><option value="de">German</option><option value="hi">Hindi</option><option value="ga">Irish</option><option value="it">Italian</option><option value="ja">Japanese</option><option value="ko">Korean</option><option value="pt">Portuguese</option><option value="ru">Russian</option><option value="es">Spanish</option><option value="auto">Auto Detect (Experimental)</option>
          </select>
        </div>
        <div className='col-1'>
      ...
      <div className="row d-flex justify-content-between">
        ...
        <div className="col-5">
          <label htmlFor="translateInput" className="form-label text-muted">Input Text</label>
          <input type="text" className="form-control" id="translateInput" onChange={onInputChange}></input>
        </div>

        <div className="col-5">
          <label htmlFor="targetInput" className="form-label text-muted">Translated</label>
      ...
      {translatedTxt ? (
        <div className='saveBtn'>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="lightgreen" class="bi bi-check-circle-fill" viewBox="0 0 16 16" onClick={addWord}>
